...
macOS-виджет, живущий в чёлке MacBook.

- **Наводишь курсор на чёлку** — из-под неё выезжает чёрный островок со знаком
  Claude: виджет работает, вот расход текущего окна, вот индикатор активности.
- **Кликаешь по островку** — чёлка раскрывается в панель с вкладками
  **Сессия · 5 часов · Неделя · Модели**: числа и графики расхода токенов.
- **Расход подходит к пределу** — островок вылезает сам и краснеет, даже если
  курсор далеко; в панели появляется плашка с предупреждением.
- Убираешь курсор — всё исчезает.

Никакой иконки в Dock, никакой сети, никаких разрешений macOS.

Процентов реального лимита подписки локально нет (Claude Code берёт их с
сервера), поэтому шкала калибруется по историческому максимуму: «78% от твоего
обычного максимума за 5 часов».
