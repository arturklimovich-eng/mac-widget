...
enum UsageReader {
    ...
    // ponytail: снимок считается в одном последовательном `Task.detached`, поэтому обычный
    // словарь без блокировки; понадобится параллельное чтение — обернуть в actor.
